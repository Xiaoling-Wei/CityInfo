      ...
      <tr>
        <td height="96" align="center" valign="top">
          <?php
			...
			$date1=date("Y-m-d");
			$sgsql=mysqli_query($conn,"select * from tb_leaguerinfo  where type='出售信息' and showday>='$date1' and checkstate=1 ");
          ...
          <table width="647" border="0" cellspacing="0" cellpadding="0" bgcolor="#FAFFF4">
            <tr>
              <td height="26"><span class="style1">『出售信息』</span><span class="style8">&nbsp;<?php echo $sginfo['title'];?>&nbsp;</span><span class="style6">&nbsp;<?php echo $sginfo['sdate'];?></span></td>
            </tr>
            <tr>
...
<?php
$sql=mysqli_query($conn,"select count(*) as total from tb_info where type='出售信息' and checkstate=1");
...
$gsql=mysqli_query($conn,"select * from tb_info where type='出售信息' and checkstate=1 order by edate desc limit ".($page-1)*$pagesize.",$pagesize");
