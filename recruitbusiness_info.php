      ...
      <tr>
        <td height="96" align="center" valign="top">
          <?php
			...
			$date1=date("Y-m-d");
			$sgsql=mysqli_query($conn,"select * from tb_leaguerinfo  where type='招商引资' and showday>='$date1' and checkstate=1 ");
          ...
          <table width="647" border="0" cellspacing="0" cellpadding="0" bgcolor="#FAFFF4">
            <tr>
              <td height="26"><span class="style1">『招商引资』</span><span class="style8">&nbsp;<?php echo $sginfo['title'];?>&nbsp;</span><span class="style6">&nbsp;<?php echo $sginfo['sdate'];?></span></td>
            </tr>
            <tr>
...
<?php
$sql=mysqli_query($conn,"select count(*) as total from tb_info where type='招商引资' and checkstate=1");
...
$gsql=mysqli_query($conn,"select * from tb_info where type='招商引资' and checkstate=1 order by edate desc limit ".($page-1)*$pagesize.",$pagesize");
...
?>
          <table width="647" border="0" cellspacing="0" cellpadding="0" bgcolor="#FAFFF4">
            <tr>
              <td height="26"><span class="style1">『招商引资』</span><span class="style8">&nbsp;<?php echo $ginfo['title'];?>&nbsp;</span><span class="style6">&nbsp;<?php echo $ginfo['edate'];?></span></td>
            </tr>
            <tr>
...
条&nbsp;每页显示<?php echo $pagesize;?>条&nbsp;第<?php echo $page;?>页/共<?php echo $pagecount; ?>页
      ...
      <a href="recruitbusiness.php?page=<?php echo $i;?>"><?php echo $i;?></a>
      <?php }?>
      <a href="recruitbusiness.php?page=<?php echo $page-1;?>" title="后一页"></a> <a href="recruitbusiness.php?page=<?php echo $pagecount;?>" title="尾页"></a>
      <?php }?></td>
  </tr>
</table>
<?php
