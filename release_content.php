...
<table width="670" height="407" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="37">&nbsp;<img src="Images/landian.gif" width="9" height="9"><strong>免费发布专区</strong></td>
  </tr>
  <tr>
	  <td>
      <form name="form1" method="post" action="release_ok.php" >
        <table width="630" border="0" cellspacing="0" cellpadding="0" bgcolor="#FAFFF4">
          <tr>
